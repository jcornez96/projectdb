	...
	<div id="header" class="header-section">
				...
				<div id="topbar-hold" class="nav-hold container">
					...
					<div class="collapse navbar-collapse navbar-responsive-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="current"><a href="viajes.jsp">Viajes</a></li>
		...
		<div id="section-home" class="home-section-wrap center">
			...
			<div class="container home">
				<div class="row">
					<h1 class="well-come">Viajes de los camiones</h1>

					<div class="col-md-8 col-md-offset-2">
						<p class="intro-message">Querie donde te muestra los viajes que realizan todos los
						camioneros o del camionero que tu eligas</p>
		...
		<div class="row">
			...
			<!-- El ul lo coloco debido a que se necesita para cambiar las propiedades del menú --!>
				<ul id="card-ul" class="features-hold">
					...
					<%
						String query = "select Empleados.idEmpleado, CONCAT(Empleados.nombre, ' ', Empleados.apellidos) from Empleados join Trabajos on (Trabajo_idTrabajo=idtrabajo) where Trabajos.nombre = 'Camionero' && Empleados.fechaBaja IS NULL";
						beanDB basededatos = new beanDB();
						String[][] tablares = basededatos.resConsultaSelectA3(query + ";");
					%>
				
				<form name="introGrupo" ACTION="viajes.jsp" method="POST">
					<select name="opciones" onchange="submit();">
							<option value=""> Elija un camionero </option>
				...
				<% 
				query = "select CONCAT(Empleados.apellidos, ', ', Empleados.nombre), DATE(fechaInicio), DATE(fechaFin), origen.nombre, destino.nombre from Viajes left join Empleados on (Empleados_idEmpleado=idEmpleado) left join Ciudades origen on (origen=origen.idCiudad) left join Ciudades destino on (destino=destino.idCiudad)";
				try {
					query += " where idEmpleado = " + request.getParameter("opciones").toString() + ""; 
				}catch (Exception e) {}
				
				query += " order by DATE(fechaInicio) DESC";
				System.out.println(query);
				tablares = basededatos.resConsultaSelectA3(query + ";");
				%>
				
				<h4> Listado de Viajes
				<% if (tablares!=null) {%>
					...
					<% if (tablares!=null){%>
						<thead class="thead inverse">
							<tr>
								...
								<th style="text-align: center;">Fecha de Vuelta</th>
