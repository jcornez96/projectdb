	   ...
	   //----- Metodo que realiza la conexion a la BD
		public void conectarBD() throws SQLException
		{
	        try{
	        	...
	        	//cn=DriverManager.getConnection("jdbc:mysql://altair1.altair.edu.es/estudio","csi1","altair");
	            cn=DriverManager.getConnection("jdbc:mysql://192.168.56.102/estudio","root","altair");
